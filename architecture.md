...
| §117–§141 | [architecture/records/](architecture/records/) | V1.x 实现记录,**每章一文件**,文件名即 § 编号 |
...
| §140 | [140-lock-keys.md](architecture/records/140-lock-keys.md) | 锁键服务:CapsLock 手势 + NumLock 守护 + 状态 OSD |
