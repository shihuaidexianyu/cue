...
use crate::host::{HOST_WINDOW_CLASS, WM_SAKANA_SHOW};
...
const MUTEX_NAME: windows::core::PCWSTR = w!("Local\\sakana.SingleInstance");
...
fn signal_first_instance() {
    unsafe {
            ...
            && !host.0.is_null()
        {
            ...
            let _ = PostMessageW(Some(host), WM_SAKANA_SHOW, WPARAM(0), LPARAM(0));
        }
    }
}
