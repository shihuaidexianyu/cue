...
/// Host 上报给编排层的事件(由 sakana binary 翻译成 Core 的 HostEvent,
/// 或直接在 handler 内拦截——见 main.rs)。
...
pub const HOST_WINDOW_CLASS: PCWSTR = w!("sakana.HostWindow");
